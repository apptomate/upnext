        ...
        <div className="row">
            ...
            <div className="col-lg-12 m-b-70">
                ...
                <div className="less_publish">
                    <img src={profileImg} className="rounded-circle float-left" alt=""></img>
            ...
            <div className="col-lg-12 m-b-100">
                ...
                <p className="m-b-50">You have successfully created and published this lesson</p>
                <p className="m-b-50 f-w-600">You have added 15 slides in this lesson.</p>                
                <p><Link to="/ViewLesson" className="m-b-50">
                <button type="button" className="btn btn-primary f-s-12 rounded-pill pr-4 pl-4 pt-2 pb-2">
                    VIEW PUBLISHED LESSON
                </button>
                </Link>
                </p>
                <p><Link to="/" className="m-b-50">
                <button type="button" className="btn btn-primary f-s-12 rounded-pill pr-4 pl-4 pt-2 pb-2">
                    EXPLORE ALL LESSONS
                </button>
                </Link>
