      ...
      <div className="container">
        <div className="row">
          ...
          <div className=" col-md-3 mt-5 mb-3 col-sm-12 crt_less">
            <Link to="/CreateLesson">
              <button type="button" className="btn btn-orange-50 btn-sm float-right f-s-12 rounded-pill pr-4 pl-4 pt-2 pb-2"><i class="far fa-file m-r-5"></i> Create a New Lesson</button>
            </Link>
        ...
        <form onSubmit={e => e.preventDefault()} className="form-inline mt-3 mb-2 searchbar">
          <div className="input-group mb-3 w-100">
            ...
            <input type="text" defaultValue="" onChange={(e) => handleOnchange(e)} className="form-control border-bottom" placeholder="Search lesson" aria-label="Search lesson" aria-describedby="basic-addon2"></input>
            <div className="input-group-append">
              <span className="input-group-text bg-white border-bottom"><i className="fas fa-arrow-right text-primary"></i></span>
            </div>
          </div>
        </form>
